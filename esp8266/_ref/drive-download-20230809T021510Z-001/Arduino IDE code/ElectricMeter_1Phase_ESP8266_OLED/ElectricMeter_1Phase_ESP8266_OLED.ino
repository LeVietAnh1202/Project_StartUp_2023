 ...
 *** CÔNG TƠ ĐIỆN TỬ WIFI 1 PHA + OLED 0.96 inch ***
 *** ELECTRIC METER 1 PHASE + OLED 0.96 inch ***
...
#define Device_Name "Electric Meter 1 Phase"
...
void ReadData()
{
  L1_voltage = pzem.voltage();
  L1_current = pzem.current();
  L1_power = pzem.power();
  L1_frequency = pzem.frequency();
  L1_pf = pzem.pf();
  L1_energy = pzem.energy();
}
void sendBlynk()
{

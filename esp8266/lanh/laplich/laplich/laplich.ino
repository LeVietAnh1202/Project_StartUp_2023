...
void setup() {
    ...
    // Khởi tạo và khai báo các luồng
    taskScheduler.init();
...
//      api_flag = 1;
    ...
    if (api_flag == 1){
//    if (digitalRead(configWifi) == HIGH) {
//      while(digitalRead(configWifi) == HIGH);
        
//        SEND_MESSAGE_API();
        taskScheduler.addTask(500, TASK_FOREVER, &SEND_MESSAGE_API);
...
//  int httpResponseCode = https.POST("{\"fcm_token\": \"dbzR0ayBT2Guzp3u3sginN:APA91bHYe_4BXRfbB9mRT9GJNLupr6M-X23i1AhvHhgg93bMSg6UzwpijIKQ063Op5JrEO3LMIOgaGg4Lkd367GuLLSNNTTUl5btWum8q8CH_AxPBkVbxZcHMbytqIBqU93xWyhGC_0x\"}");
  // vietanh token
  int httpResponseCode = https.POST("{\"fcm_token\": \"dled7wpYSUWV7RXGsVAWNw:APA91bH_6c75YlFFDU3csSOkgKD6u26h1fGm6nCyE6l-yVNfi1tY1ajmBm35jcSjn4WLXAOFPwkzkxcFlAUXZ8uLtbRNMotggbFZe27V2XZ8WkdAYo5qxxmRFgNGFXjVVAsi8xnt9XPR\"}");
